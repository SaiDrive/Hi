  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-slate-800 rounded-lg shadow-xl p-6 w-full max-w-md">
        <h2 className="text-2xl font-bold mb-4 text-indigo-400">Schedule Post</h2>
        <p className="mb-4 text-slate-300">Select a date and time to post this content.</p>
        <div className="mb-6">
          <label htmlFor="schedule-time" className="block text-sm font-medium text-slate-400 mb-2">
            Post at:
          </label>
          <input
            type="datetime-local"
            ...
            className="w-full bg-slate-900 border border-slate-700 rounded-md p-2 text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
        ...
        <div className="flex justify-end space-x-4">
          <button
            onClick={onClose}
            className="px-4 py-2 rounded-md bg-slate-600 hover:bg-slate-700 transition-colors"
          >
            Cancel
          </button>
          <button
